...
<div class="row m-5">
    <div class=" sidebar-menu mt-4 ml-4 col-2">
        ...
        <div>
           <a href="<?= base_url('index.php/fitur_categories/category/home_utensils') ?>" class="nav-link font-weight-bold" style="color:#730006"><span><strong>Home Utensils</strong></span><span class="badge badge-secondary"></span></a>
    ...
    <div class="col-9 py-6">
        <?php foreach($home_utensils as $dt) :?>
            <div class="span"> 
